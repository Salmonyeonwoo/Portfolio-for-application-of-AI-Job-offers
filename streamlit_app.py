# ================================
# Streamlit Cloud + Local Dual Mode (Fixed Rich Conflict)
    ...
    with st.spinner("LSTM 모델 로드 및 학습 중..."):
        try:
            ...
            if avg_predict > avg_recent:
                ...
                comment = "성취도가 다소 하락할 수 있습니다. RAG 챗봇을 활용해 기초 개념 확인을 추천합니다."
            else:
                comment = "성취도는 현재 수준 유지 예상. 새로운 콘텐츠로 학습 활력 추가를 고려하세요."
            st.info(comment)
